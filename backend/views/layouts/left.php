        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Подписчики', 'icon' => 'fa fa-circle-o', 'url' => ['subscriber/']],
                    ['label' => 'Статические страницы', 'icon' => 'fa fa-circle-o', 'url' => ['page/']],
                    ['label' => 'Размеры', 'icon' => 'fa fa-circle-o', 'url' => ['size/']],
                    ['label' => 'Комментарии пользователей', 'icon' => 'fa fa-circle-o', 'url' => ['comment/']]
                ],
            ]
        ) ?>
