...
<?php $this->beginBody() ?>
<?php
if (Yii::$app->session->hasFlash('coupon')) {
    $message = Yii::$app->session->getFlash('coupon');
    if ($message === true) {
        $this->registerJs('popupSuccess()', View::POS_READY);
    } else {
        $this->registerJs("notify('$message')", View::POS_READY);
    }
}
?>
<?= $this->render('metriks')?>
        ...
        <nav class="scroll-nav">
            <ul>
                    ...
                    <div class="dropdown-catalog">
                        ...
                        <div class="dropdown-catalog-man">
                            <a href="<?= Url::to(['category/view', 'slug' => $catalog_man->slug])?>" class="title"><span>МУЖСКАЯ ОДЕЖДА</span></a>
                                <?php $children = Category::findAll(['parent' => $catalog_man->id])?>
                        ...
                        <div class="dropdown-catalog-woman">
                            ...
                            <?php $children = Category::findAll(['parent' => $catalog_woman->id])?>
                            <?php foreach ($children as $child) :?>
                                <a href="<?= Url::to(['category/view', 'slug' => $child->slug])?>" class="dropdown-catalog-section"><span><?= $child->name?></span></a>
                            <?php endforeach;?>
                        </div>
                ...
                <li class="delivery-parent"><a href="<?= Url::to(['page/view', 'slug' => 'delivery'])?>" class="delivery">ДОСТАВКА И ОПЛАТА</a>
                    <a href="<?= Url::to(['page/view', 'slug' => 'delivery'])?>" class="delivery-icon"><img src="data/img/tick.svg" alt=""></a></li>
    ...
    <div class="header-right">
        ...
        <div class="callback-parent header-dropdown-parent">
            ...
            <div class="callback-dropdown">
                <form action="order/fast.html" method="post">
        ...
        <div class="add-to-cart-parent header-dropdown-parent">
            ...
            <div class="dropdown-cart">
                ...
                <?php endforeach;?>
                    ...
                    <a href="<?= Url::to(['cart/view'])  // TODO open popap in cart/view?>" class="dropdown-cart-checkout">ОФОРМИТЬ ЗАКАЗ</a>
            ...
            <div class="subscribe">
                <div class="signup-form">
                    <form action="subscriber/create.html" method="post">
                        <input type="hidden" name="_csrf-frontend" value="<?= Yii::$app->request->csrfToken?>">
                        <input type="text" name="Subscriber[name]" placeholder="Введи свое имя">
        ...
        <nav class="mobile-menu-nav">
            <ul>
                <li class="mobile-nav-parent">
                    <a href="javascript:;" class="mobile-nav-category">КАТАЛОГ</a>
                    ...
                    <ul class="mobile-nav-child">
                        ...
                        <?php foreach ($categories as $category) :?>
                            <li><a href="<?= Url::to(['category/view', 'slug' => $category->slug])?>"><?= $category->name?></a></li>
                        <?php endforeach;?>
                    </ul>
                </li>
    ...
    <div class="mobile-menu">
        ...
        <nav class="mobile-menu-nav">
            <ul>
                ...
                <li><a href="javascript:;" class="mobile-nav-category">О БРЕНДЕ</a></li>
                <li class="mobile-nav-parent">
                    <a href="javascript:;" class="mobile-nav-category">ДОСТАВКА И ОПЛАТА</a>
                    <a href="javascript:;" class="mobile-nav-parent-btn"></a>
                </li>
                <li><a href="javascript:;" class="mobile-nav-category">КОНТАКТЫ</a></li>
            </ul>
        </nav>
    ...
    <div class="catalog-mobile-menu">
        ...
        <nav class="mobile-menu-nav">
            <div class="catalog-man">
                <a href="javascript:;" class="title"><span>МУЖСКАЯ ОДЕЖДА</span></a>
                <a href="javascript:;" class="catalog-section"><span>Футболки</span></a>
                <a href="javascript:;"class="catalog-section"><span>Поло</span></a>
                <a href="javascript:;"class="catalog-section"><span>Шорты</span></a>
                <a href="javascript:;"class="catalog-section"><span>Капри</span></a>
                <a href="javascript:;"class="catalog-section">Куртки</a>
                <a href="javascript:;"class="catalog-section">Аксессуары</a>
                <a href="javascript:;"class="catalog-section">Шапки</a>
                <a href="javascript:;"class="catalog-section">Нижнее белье</a>
                <a href="javascript:;"class="catalog-section">Тапки</a>
            </div>
            <div class="catalog-woman">
                <a href="javascript:;" class="title">ЖЕНСКАЯ ОДЕЖДА</a>
                <a href="javascript:;" class="catalog-section">Куртки</a>
                <a href="javascript:;" class="catalog-section">Аксессуары</a>
                <a href="javascript:;" class="catalog-section">Шапки</a>
                <a href="javascript:;" class="catalog-section">Футболки</a>
                <a href="javascript:;" class="catalog-section">Поло</a>
                <a href="javascript:;" class="catalog-section">Шорты</a>
            </div>
        </nav>
